...
SESSION_ID: process.env.SESSION_ID === undefined ? 'VAJIRA-MD=2JcCXLbJ#CgJGw0gw7vGInqnfuG7Ul4QHfQmNWHd_plK7zaKKANs' : process.env.SESSION_ID,
...
AUTO_STICKER: process.env.AUTO_STICKER || tue  ,    
